...
| `INTROSPECT_TIMEOUT_MS` | api-gateway | N | `5000` | Timeout (ms) khi gateway introspect sang core lúc Redis miss; quá hạn trả `SYS_504` (504), không kết nối được/core 5xx trả `SYS_502` (502). |
