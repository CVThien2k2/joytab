 ...
 *  - Member: rời tổ chức, qua hộp thoại chung LeaveOrganizationDialog.
 *
 *         Trong luồng thật member KHÔNG tới được đây nữa (trang Tổ chức tự đá họ về lịch, xem
 *         page.tsx) — đường rời tổ chức của họ nằm ở menu tài khoản trên sidebar. Nhánh member
 *         giữ lại ở đây vì component nhận vào một tổ chức bất kỳ chứ không tự giả định vai trò,
 *         và nó chỉ còn là ba dòng gọi hộp thoại chung, không phải một bản chép tay thứ hai.
 *
