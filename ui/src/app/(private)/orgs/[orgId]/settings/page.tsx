 ...
 * Output: Trang cấu hình tổ chức: thông tin + cấu hình + danh sách thành viên + hành động
 *         rời/xoá.
 *
 ...
 *
 *         Ở `/settings` chứ không còn ở gốc `/orgs/<id>`: gốc giờ là trang chủ mà ai cũng mở
 *         hàng ngày, còn đây là màn vài tháng sửa một lần.
 *
 *         CHỈ owner vào được. Cả trang này là chỗ đọc và đổi cấu hình tổ chức cùng danh sách
 *         thành viên — việc của chủ tổ chức. Member bị đá về trang chủ: sidebar đã không còn
